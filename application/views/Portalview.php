...
<head>
    ...
    <script type="text/javascript" src="http://www.openapis.col.gob.mx/API_PU/js/b4/jquery-3.2.1.js">
    ...
    <script type="text/javascript" src="//script.crazyegg.com/pages/scripts/0085/1528.js" async="async">
    	
    </script>
    <script type="text/javascript" src="//platform-api.sharethis.com/js/sharethis.js#property=59cd2679fdc69400125962c9&amp;product=inline-share-buttons">
...
<body data-url="http://www.openapis.col.gob.mx/API_PU/" id="Body">
  <!-- nav container -->
    <div id="GobNavbar" class="container-fluid navbar-container-pu op GobNavbar fixed-top menu-background-transparent-pu" style=""> 
      <div class="container">
	<div class="row">
  	   <div class="col">
          <nav class="navbar navbar-toggleable-md navbar-light ">
		  <button class="navbar-toggler navbar-toggler-right custom-toggler collapsed" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
		    <span class="navbar-toggler-icon"></span>
		  </button>
		  <a class="navbar-brand" href="http://www.col.gob.mx/">
		  	<img src="http://www.openapis.col.gob.mx/API_PU/img/colimaestado.png" class="nav-image-colima-estado" title="Ir al portal" alt="colima estado">
		  </a>
		  <div class="navbar-collapse justify-content-md-center collapse" id="navbarNavDropdown" aria-expanded="false" style="">
		    <ul class="navbar-nav">
		      		      <li class="nav-item active">
		        <a class="nav-link" href="http://www.col.gob.mx/Portal/Tramites">Trámites <span class="sr-only">(current)</span></a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link" href="http://www.col.gob.mx/Portal/detalle_secretarias">Gobierno</a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link" href="http://www.col.gob.mx/Portal/#sec_atencion">Contáctanos</a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link cursor" target="_blank" href="http://www.col.gob.mx/DatosAbiertos">Datos</a>
		      </li>
		      <li class="nav-item">
		      	<a href="http://www.col.gob.mx/transparencia/" class="nav-link cursor" target="_blank">Transparencia</a>
		      </li>
		      <li class="nav-item">
				  	<a class="nav-link cursor denuncia-menu" href="http://www.col.gob.mx/index.php/Portal/denuncia">DENUNCIA</a>
				</li>
		      <li class="nav-item">
		      ...
		      <form id="formBusqueda" method="GET" action="http://www.col.gob.mx/Portal/detalle_busqueda" class="nav-item display-none">
...
<a href="#" class="scrollToTop ui-draggable ui-draggable-handle" id="ScrollTop" style="display: inline;"></a>
		...
		<div class="col-12">
			<ol class="breadcrumb pull-right">
				<li class="breadcrumb-item">
					<a href="http://www.col.gob.mx/" title="Gobierno del estado de colima">
					<img class="bread-pbc" src="http://www.col.gob.mx/assets/img/escudo_breadcrum.png" alt="Gobierno colima">col.gob.mx</a></li>
					<li class="breditem-pt2 breadcrumb-item "><a href="http://www.col.gob.mx/Portal" title="">Portal</a></li>
					<li class="breditem-pt2 breadcrumb-item active"><a href="" title="">Trámites</a></li></ol>		</div>
	</div>
...
<div class="container" id="sec_atencion" style="padding-top: 40px;"><br><br>
	...
	<div class="row">
		...
		<div class="col-md-4 col-6 no-padding-left-right" style="padding-right: 3px;">
			<a href="javascript:TipoTramite(1);">
				<div id="BGL1" class="Fill-1">
					<div id="BGL2" class="col-2 Fill-2">
...
<div id="TramiteEnLinea">
		...
		<ul class="nav nav-tabs2" role="tablist">
			...
			<li>
				<form class="input-group Busqueda" id="frmBusquedaLinea">
					...
					<span class="input-group-btn">
                                      <button class="btn btn-default custom-buttom-noticias" id="btn-busqueda-linea" type="submit">
	...
	<div id="ContentTramiteEnLinea" class="tab-content">
		...
		<div role="tabpanel" class="tab-pane" id="Dependencias" style="display: none;">
			<div class="browse-panes section subsection">
				<div class="pane third" style="padding-left: 20px;">
		...
		<ul class="nav nav-tabs2" role="tablist">
			...
			<li>
				<form class="input-group Busqueda" id="frmBusquedaRetys">
					...
					<span class="input-group-btn">
						  <button class="btn btn-default custom-buttom-noticias" id="btn-busqueda-retys" type="submit">
								<span class="fa fa-chevron-right"></span>
						  </button>
					</span>
...
<script type="text/javascript">  
	...
	<div id="resultadoBusqueda" style="display: none;">
		...
		<table class="table table-striped" id="table-tramites" style="display: none;">
		  <thead>
		    <tr>
		      <th>#</th>
		      <th>Trámites</th>
...
</main><iframe src="https://c.sharethis.mgr.consensu.org/v1.0/cmp/portal.html" id="st_gdpr_iframe" title="GDPR Consent Management" style="width: 0px; height: 0px; position: absolute; left: -5000px;"></iframe>
<script type="text/javascript">
	$(function() {
		TipoTramite(1);
	 	TramitesLinea(1);
                        ...
                        <div class="row">
                        	<div class="col-md-8">
                        		<div class="form-group">
		                            <div class="g-recaptcha" data-sitekey="6LcJhlgUAAAAAMuyT1TGklVsDJvfSspi1DQZxQg4" style="transform:scale(0.77);-webkit-transform:scale(0.77);transform-origin:0 0;-webkit-transform-origin:0 0;"><div style="width: 304px; height: 78px;"><div><iframe src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LcJhlgUAAAAAMuyT1TGklVsDJvfSspi1DQZxQg4&amp;co=aHR0cDovL3d3dy5jb2wuZ29iLm14Ojgw&amp;hl=es&amp;v=v1562567553145&amp;size=normal&amp;cb=eyltoalyv47s" width="304" height="78" role="presentation" name="a-2u2dln5wxhz" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
...
<div class="modal fade" id="mdlMensaje" name="mdlMensaje" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true" style="padding-top:15%; overflow-y:visible;">
   ...
   <footer class="footer">
	   			...
	   			<div class="col-md-6 col-12 container-img-footer">
	   			 	<div class="row">
	   			 		...
	   			 		<div class="col-md-12 col-12 hidden-sm-down">
	   			 			<p class="footer-texto-pu ">Complejo Administrativo del Gobierno del Estado 3er. Anillo Periférico, Esq. Ejército Mexicano S/N. Colonia el Diezmo. C.P. 28010, Colima, Colima, México. Tel. (312) 316 2000</p>
	   			 		</div>
                            ...
                            <a class="linksfooter" href="http://www.col.gob.mx/Portal/mapa_sitio" target="_self" title="">Mapa del sitio</a> <br>
	   			 			<a target="_blank" class="linksfooter" href="http://www.col.gob.mx/Portal/contenido/MTA3MzI=" title="Políticas de uso">Políticas de uso y privacidad</a>
	   			 	...
	   			 	<div class="row footer-social-separador-pu">
	   			 		 <div class="col-12 text-center footer-social-separador-pu"> 
			   			 	<ul class="list-inline">
			   			 	  <li class="list-inline-item"><span class="footer-icon-separador-pu"></span><a href="https://www.facebook.com/gobiernocolima/" target="_blank" title="Facebook"><i class="fa fa-facebook-official footer-facebook fa-3x" aria-hidden="true"></i></a></li>
							  <li class="list-inline-item "><span class="footer-icon-separador-pu"></span><a href="https://twitter.com/gobiernocolima" target="_blank" title="Twitter"><i class="fa fa-twitter-square footer-twitter fa-3x" aria-hidden="true"></i></a></li>
							  <li class="list-inline-item "><span class="footer-icon-separador-pu"></span><a href="https://www.youtube.com/user/GobiernoColima" target="_blank" title="Youtube"><i class="fa fa-youtube-play footer-youtube fa-3x" aria-hidden="true"></i></a></li>
							  <li class="list-inline-item "><span class="footer-icon-separador-pu"></span><a href="http://gobiernocolima.blogspot.mx/" target="_blank" title="Blogspot"><i class="fa fa-rss-square footer-rss fa-3x" aria-hidden="true"></i></a></li>
							  <li class="list-inline-item "><span class="footer-icon-separador-pu"></span><a href="https://soundcloud.com/gobcolradio/" target="_blank" title="SoundCloud"><i class="fa fa-soundcloud footer-soundcloud fa-3x" aria-hidden="true"></i></a></li>
							</ul>
	   			 		</div> 
	   			 		<div class="col-12">
                        <div class="row padding-left-30">
                        	...
                        	<div class="col text-center">
                        		<i class="fa fa-check-circle-o fa-2x" aria-hidden="true"></i><br>
			   			 	  		<a href="http://validacion.col.gob.mx/" target="_blank" title="Validación de documentos con firma electrónica" class="linksfooter">Validación &nbsp; <br> de documentos</a>
                        	</div>
                        </div>
	   			 		</div>
	   			 	</div>
    ...
    <!-- Font awesome -->
    <script type="text/javascript"> var site_url ='http://www.col.gob.mx/index.php'; </script>
    <script src="http://www.col.gob.mx/assets/js/customjs.js" type="text/javascript"></script>
    <script src="http://www.col.gob.mx/assets/js/menu-fixed-top.js" charset="utf-8" type="text/javascript">
    	
    </script><script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js" type="text/javascript"></script> <script src="http://www.col.gob.mx/assets/js/jquery.validate.min.js" type="text/javascript"></script>
    <script src="http://www.col.gob.mx/assets/js/additional-methods.js" type="text/javascript"></script>
    <script src="https://www.google.com/recaptcha/api.js"></script>
    <script src="http://www.col.gob.mx/assets/js/enviar-email.js" type="text/javascript">	
    </script>
    <script src="http://www.col.gob.mx/assets/js/busquedageneral.js" type="text/javascript"></script>
    <script src="http://www.col.gob.mx/assets/js/destacados.js" type="text/javascript"></script>
    <script type="text/javascript" src="http://www.openapis.col.gob.mx/API_PU/js/b4/colgob.js"></script>
	<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"d4962eb93a","applicationID":"128179107","transactionName":"YQMDMEYHV0QHWkxdXFhJNBZdSVBZAlxAGkNeFg==","queueTime":0,"applicationTime":9,"atts":"TUQARg4dREo=","errorBeacon":"bam.nr-data.net","agent":""}
	</script>
<br><i class="fa fa-bullseye" aria-hidden="true" style="color: white;position: absolute;font-size: 8px;"></i>

<div style="background-color: rgb(255, 255, 255); border: 1px solid rgb(204, 204, 204); box-shadow: rgba(0, 0, 0, 0.2) 2px 2px 3px; position: absolute; transition: visibility 0s linear 0.3s, opacity 0.3s linear; opacity: 0; visibility: hidden; z-index: 2000000000; left: 0px; top: -10000px;"><div style="width: 100%; height: 100%; position: fixed; top: 0px; left: 0px; z-index: 2000000000; background-color: rgb(255, 255, 255); opacity: 0.05;"></div>
...
<div style="z-index: 2000000000; position: relative;"><iframe title="Reto recaptcha" src="https://www.google.com/recaptcha/api2/bframe?hl=es&amp;v=v1562567553145&amp;k=6LcJhlgUAAAAAMuyT1TGklVsDJvfSspi1DQZxQg4&amp;cb=4740dxtqcn72" name="c-2u2dln5wxhz" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox" style="width: 100%; height: 100%;"></iframe>
</div>
</div>
</body>
</html>